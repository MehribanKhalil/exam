  ...
  return (
    ...
    <div className=" bg-[#F8F9FB]">
      ...
      <div className='py-4 flex  items-center justify-center gap-3'>
        <button onClick={()=>decCount(product)} className='border border-main-color rounded-xl px-3 py-1 text-xl flex justify-center items-center'>-</button>
        <span className=' text-2xl'>{count}</span>
        <button onClick={()=>incCount(product)} className='border border-main-color rounded-xl px-3 py-1 text-xl flex justify-center items-center'>+</button>
      </div>

      <div className=' pb-5'>
        <button  onClick={()=>deleteBasket(_id)} className=" text-sm pb-3 border font-semibold border-main-color px-6 py-2">
         Delete
        </button>
      </div>
