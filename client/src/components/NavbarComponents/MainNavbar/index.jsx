      ...
      <div className=' flex justify-between gap-5 md:gap-32 px-3 md:px-16 items-center'>
       ...
       <div>
        ...
        <div className='hidden md:flex  gap-6 items-center font-semibold uppercase text-sm'>
            ...
            <NavLink to={'/wishlist'} >
              <button className=' relative'><i class="fa-solid fa-heart text-2xl"></i> 
                <span className=' bg-red-600 rounded-full text-white text-sm w-4 h-4 flex justify-center items-center absolute -top-1 -right-2'>{wishlist.length}</span>
              </button>
            </NavLink>
            <NavLink to={'/basket'} >
            <button className=' relative'><i class="fa-solid fa-cart-shopping text-2xl"></i>
                <span className=' bg-red-600 rounded-full text-white text-sm w-4 h-4 flex justify-center items-center absolute -top-1 -right-2'>{basket.length}</span>
              </button>
            </NavLink>
        </div>
       </div>
        ...
        <div className=' md:hidden px-5 '>
            <button onClick={()=>setIsMobileOpen(!isMobileOpen)} className='  text-3xl'><i className="fa-solid fa-bars"></i></button>
        </div>
      </div>
    </nav>
  )
